/*!
 * Circle Progress01 - v0.1.0 - 2019-10-04
 * https://tigrr.github.io/circle-progress01/
        ...
        var c = function () {
            var c = {
                ...
                function d(b) {
                    ...
                    var f = void 0;
                    if ("string" == typeof b && (b = e.querySelector(b)), !b) throw new Error("CircleProgress01: you must pass the container element as the first argument");
                    return b.circleProgress01 ? b.circleProgress01 : (b.circleProgress01 = this, this.doc = e, b.setAttribute("role", "progress01bar"), this.el = b, c = _extends({}, d.defaults, c), Object.defineProperty(this, "_attrs", {
                        value: {},
                        enumerable: !1
                    }), f = "valueOnCircle" === c.textFormat ? 16 : 8, this.graph = {
                        paper: a(b, 100, 100),
                        angle: 0
                    }, this.graph.paper.svg.setAttribute("class", "circle-progress01"), this.graph.circle = this.graph.paper.element("circle").attr({
                        "class": "circle-progress01-circle",
                        cx: 50,
                        cy: 50,
                        r: 50 - f / 2,
                        fill: "none",
                        ...
                        "class": "circle-progress01-value",
                        fill: "none",
                        stroke: "#00E699",
                        "stroke-width": f
                    }), this.graph.text = this.graph.paper.element("text", {
                        "class": "circle-progress01-text",
                        x: 50,
                        y: 50,
                ...
                return _createClass(d, [{
                    ...
                    key: "_formatValue", value: function (a, c) {
                        switch (a) {
                            ...
                            case"indeterminateText":
                                ...
                                break;
                            case"textFormat":
                                if ("function" != typeof c && -1 === ["valueOnCircle", "horizontal", "vertical", "percent", "value", "none"].indexOf(c)) throw new Error('Failed to set the "textFormat" property on CircleProgress01: the provided value "' + c + '" is not a legal textFormat identifier.');
                                break;
                            case"animation":
                                if ("string" != typeof c) throw new TypeError('Failed to set "animation" property on CircleProgress01: the value must be string, ' + ("undefined" == typeof c ? "undefined" : _typeof(c)) + " passed.");
                                if ("none" !== c && !b.easings[c]) throw new Error('Failed to set "animation" on CircleProgress01: the provided value ' + c + " is not a legal easing function name.")
                        }
                        return c
                    }
                }, {
                    ...
                    key: "_positionValueText", value: function (a) {
                        ...
                        this.graph.textVal.attr({x: 50 + b.x, y: 50 + b.y})
                    }
                }, {
                    key: "_initText", value: function () {
                        switch (this.graph.text.content(""), this.textFormat) {
                            case"valueOnCircle":
                                ...
                                break;
                            case"horizontal":
                                this.graph.textVal = this.graph.paper.element("tspan", {"class": "circle-progress01-text-value"}, "", this.graph.text), this.graph.textSeparator = this.graph.paper.element("tspan", {"class": "circle-progress01-text-separator"}, "/", this.graph.text), this.graph.textMax = this.graph.paper.element("tspan", {"class": "circle-progress01-text-max"}, "", this.graph.text);
                                break;
                            case"vertical":
                                this.graph.text.el.hasAttribute("dominant-baseline") && this.graph.text.attr("dominant-baseline", "text-after-edge"), this.graph.textVal = this.graph.paper.element("tspan", {
                                    ...
                                    "class": "circle-progress01-text-separator",
                                    x: 50,
                                    dy: "0.1em",
